...
filtered_data_selection <- data_selection %>% 
  ...
  mutate(Age_Plantation_annee = as.numeric(Age_Plantation_annee)) # as.numeric
...
ref_code_espece <- ref_code_espece |> 
  select("Code_Arbre", "Nom_Vernaculaire", "Famille", "Genre", "Espece","Libelle_Plantation")
...
# Compare AGB slopes by localisation
