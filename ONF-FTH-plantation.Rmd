...
1.  Remove fictive data part and mortality model

2.  Explication of mickaelis menten model, application for high o trees

3.  Simplify volume model (sum of individual volumes)

4.  Séparer les densité de tige et les surfaces selon les parcelles.

5.  Add data from 2025

6.  Change nls() to brms()

7.  Tout traduire en Anglais
