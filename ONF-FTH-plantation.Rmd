...
# ---- Methods to fix NA bug models ----
# ---- pin caraibes ----
# Inv_complet <- Inv_complet[Inv_complet$Nom_Vernaculaire == "pin caraibes", ]
# view <- Inv_complet[Inv_complet$Age_Plantation_annee == 46, ]
# head(view)
...
2.  Modify volume model without mortality model (sum of volumes)

3.  Tout traduire en Anglais
