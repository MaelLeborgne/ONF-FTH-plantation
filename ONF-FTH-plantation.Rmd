...
# Count table on plantations and species
df_sp_plantation <- as.data.frame(table(select_species[c("Libelle_Plantation", "Nom_Vernaculaire")]) %>% addmargins()) %>%
...
# Nom complet des site de plantation
